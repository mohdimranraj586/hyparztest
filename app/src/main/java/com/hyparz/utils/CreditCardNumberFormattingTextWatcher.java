...
public class CreditCardNumberFormattingTextWatcher implements TextWatcher {
     ...
     */
    public CreditCardNumberFormattingTextWatcher(int paddingPx) {
     ...
     */
    public CreditCardNumberFormattingTextWatcher(@NonNull TextView textView) {
     ...
     */
    public CreditCardNumberFormattingTextWatcher(@NonNull TextView textView, float paddingEm) {
     ...
     */
    public CreditCardNumberFormattingTextWatcher(@NonNull Context context, float paddingSp) {
